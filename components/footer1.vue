<template>
  <div class="footer1-footer1 thq-section-padding">
    <div class="footer1-max-width thq-section-max-width">
      <div class="footer1-content">
        <div class="footer1-newsletter">
          <img :alt="logoAlt" :src="logoSrc" class="footer1-image1" />
          ...
          <div class="footer1-actions">
            ...
            <span class="footer1-content2 thq-body-small">{{ content2 }}</span>
          </div>
        </div>
        <div class="footer1-links">
          <div class="footer1-column1">
            ...
            <div class="footer1-footer-links">
              <span class="thq-body-small">{{ link1 }}</span>
              <span class="thq-body-small">{{ link2 }}</span>
              <span class="thq-body-small">{{ link3 }}</span>
              <span class="thq-body-small">{{ link4 }}</span>
              <span class="thq-body-small">{{ link5 }}</span>
            </div>
          </div>
          <div class="footer1-column2">
            ...
            <div class="footer1-footer-links1">
              <span class="thq-body-small">{{ link6 }}</span>
              <span class="thq-body-small">{{ link7 }}</span>
              <span class="thq-body-small">{{ link8 }}</span>
              <span class="thq-body-small">{{ link9 }}</span>
              <span class="thq-body-small">{{ link10 }}</span>
            </div>
          </div>
      ...
      <div class="footer1-credits">
        ...
        <div class="footer1-row">
          <span class="thq-body-small">{{ content3 }}</span>
          <div class="footer1-footer-links2">
            <span class="thq-body-small">{{ privacyLink }}</span>
            <span class="thq-body-small">{{ termsLink }}</span>
            <span class="thq-body-small">{{ cookiesLink }}</span>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  props: {
    ...
    content3: {
      type: String,
      default: 'Connect with us on social media for more insights and tips.',
    },
    link7: {
      type: String,
