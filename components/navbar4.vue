    ...
    <header data-thq="thq-navbar" class="navbar4-navbar-interactive">
      ...
      <div data-thq="thq-navbar-nav" class="navbar4-desktop-menu">
        <nav class="navbar4-links">
          ...
          <span class="thq-body-small thq-link">{{ link5 }}</span>
        </nav>
        <div class="navbar4-buttons">
          <button class="navbar4-action1 thq-button-animated thq-button-filled">
            <span class="thq-body-small">Action 1</span>
          </button>
          <button class="navbar4-action2 thq-button-outline thq-button-animated">
...
export default {
  ...
  props: {
    ...
    logoAlt: {
      type: String,
      default: 'Marketing Services Logo',
    },
    link3: {
      type: String,
